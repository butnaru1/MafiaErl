...
-export([start/2, stop/1, install/1, add_friend/4,
  add_service/4, friend_by_name/1, find_services/1,
  friend_by_expertise/1, debts/1, add_enemy/2,
  find_enemy/1, enemy_killed/1]).
